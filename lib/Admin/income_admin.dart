...
class _IncomeListScreenState extends State<IncomeListScreen> {
  ...
  Future<void> fetchData() async {
    final response = await http.get(Uri.parse('$globalapiUrl/income/'));

    if (response.statusCode == 200) {
      setState(() {
        incomeList = jsonDecode(response.body);
      });
    } else {
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      // Handle income item tap, if needed
                    },
                  ),
                );
              },
